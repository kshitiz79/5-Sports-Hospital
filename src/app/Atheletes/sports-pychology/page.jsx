...
import sportsPsychologyData from './../../../../public/sports-psychology.json';
...
const keyBenefits = [
  {
    number: "01",
    heading: "Mental resilience isn’t a gift—it’s a skill.",
    description: "Natural talent can only take you so far. Without mental resilience, pressure will break you. Our program teaches you to stay composed, push through setbacks, and thrive in high-stakes moments.",
  },
  {
    number: "02",
    heading: "Focus under pressure doesn’t come naturally.",
    description: "Distractions can derail even the best athletes. Without the right mental training, your focus will falter when it matters most. We train you to lock in and perform, no matter the stakes.",
  },
  {
    number: "03",
    heading: "Setbacks don’t define you—your response does.",
    description: "Injuries, losses, and failures are part of the game. But without proper mental tools, they can spiral into self-doubt. Our techniques help you recover faster, rebuild confidence, and come back stronger.",
  },
];
      ...
      <section className="relative py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
        ...
        >
          ...
          >
            ...
            <span className="mx-2 text-gray-500">/</span>
            <span className="text-green-600 dark:text-green-500">Sports Psychology</span>
          </motion.nav>
